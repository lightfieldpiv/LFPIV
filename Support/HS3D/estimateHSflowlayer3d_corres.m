function uv = estimateHSflowlayer3d_corres(source,target,uv,lambda,uv_corres,F)
% maxwarping
...
%           Iz*It+lambda*L*W;];
    ...
    A = [Ix*Ix+lambda*L+lambda_corres*F Ix*Iy Ix*Iz;...
        Ix*Iy Iy*Iy+lambda*L+lambda_corres*F Iy*Iz;...
        Ix*Iz Iy*Iz Iz*Iz+lambda*L+lambda_corres*F];
    
    b = -[Ix*It+lambda*L*U+lambda_corres*F*U-lambda_corres*F*u_vector;...
          Iy*It+lambda*L*V+lambda_corres*F*V-lambda_corres*F*v_vector;...
          Iz*It+lambda*L*W+lambda_corres*F*W-lambda_corres*F*w_vector;];
